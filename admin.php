...
<div class="testbox">
    <div class="banner">
<center><h1 class="heading">Pushpa Infracon</h1></center>
</div>
...
<div id="sidebar-menu">
                        ...
                        <ul>
                           ...
                           <li class="has_sub1">
                             ...
                             <li class="has_sub1">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-account-box"></i><span>Exit</span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                <input type="button" value="Close" name="close" id="close" class="btn btn-primary" onclick="location.href = '../';">
