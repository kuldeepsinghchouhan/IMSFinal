...
<body>
    <center>
        <div class="login">
            <img src="../assets/images/ceramic1.svg" alt="" style="width: 100%;">
            <br>
...
<script>
    function checkData() {
        ...
        }else if(document.getElementById('username').value == "1" && document.getElementById('admin_pass').value == password){
